...
namespace MyDhathuru.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260317155407_AddQuotationDeliveryNoteConversion")]
    partial class AddQuotationDeliveryNoteConversion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyDhathuru.Domain.Entities.AdminEmailCampaign", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("FailedCompanyCount")
                        .HasColumnType("integer");

                    b.Property<bool>("IncludeDisabledBusinesses")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("boolean");

                    b.Property<int>("RequestedCompanyCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("SentCompanyCount")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AdminEmailCampaigns");
                });

            modelBuilder.Entity("MyDhathuru.Domain.Entities.AdminEmailCampaignRecipient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("AdminEmailCampaignId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AdminEmailCampaignId", "AttemptedAt");

                    b.HasIndex("TenantId", "AttemptedAt");

                    b.ToTable("AdminEmailCampaignRecipients");
                });
            ...
            modelBuilder.Entity("MyDhathuru.Domain.Entities.BptAdjustment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "BptCategoryId", "ApprovalStatus");

                    b.ToTable("BptAdjustments");
                });

            modelBuilder.Entity("MyDhathuru.Domain.Entities.BptCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BptCategories");
                });

            modelBuilder.Entity("MyDhathuru.Domain.Entities.BptMappingRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SalesAdjustmentType")
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)");
                    ...
                    b.HasIndex("TenantId", "BptCategoryId", "IsActive");

                    b.HasIndex("TenantId", "ExpenseCategoryId", "SourceModule", "IsActive");

                    b.ToTable("BptMappingRules");
                });
            ...
            modelBuilder.Entity("MyDhathuru.Domain.Entities.ExchangeRate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MyDhathuru.Domain.Entities.Invoice", b =>
                {
                    ...
                    b.Property<string>("LastEmailedCc")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("MyDhathuru.Domain.Entities.OtherIncomeEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MyDhathuru.Domain.Entities.SalesAdjustment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "AdjustmentType", "ApprovalStatus");

                    b.ToTable("SalesAdjustments");
                });
            ...
            modelBuilder.Entity("MyDhathuru.Domain.Entities.StaffConductExportDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("StaffConductFormId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("StaffConductFormId");

                    b.HasIndex("TenantId", "StaffConductFormId", "Language")
                        .IsUnique();

                    b.ToTable("StaffConductExportDocuments");
                });
            ...
            modelBuilder.Entity("MyDhathuru.Domain.Entities.StaffConductForm", b =>
                {
                    ...
                    b.Property<string>("AcknowledgementDv")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
                    ...
                    b.Property<string>("ActionTakenDv")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
                    ...
                    b.Property<string>("EmployeeRemarksDv")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
                    ...
                    b.Property<string>("IncidentDetailsDv")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");
                    ...
                    b.Property<string>("RequiredImprovementDv")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
                    ...
                    b.Property<string>("ResolutionNotesDv")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
            ...
            modelBuilder.Entity("MyDhathuru.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("DemoDataGeneratedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("MyDhathuru.Domain.Entities.TenantSettings", b =>
                {
                    ...
                    b.Property<string>("CompanyStampUrl")
                        .HasMaxLength(400)
                        .HasColumnType("character varying(400)");
                    ...
                    b.Property<string>("PurchaseOrderEmailBodyTemplate")
                        .IsRequired()
                        .HasMaxLength(4000)
                        .HasColumnType("character varying(4000)");
                    ...
                    b.Property<string>("QuotationEmailBodyTemplate")
                        .IsRequired()
                        .HasMaxLength(4000)
                        .HasColumnType("character varying(4000)");
            ...
            modelBuilder.Entity("MyDhathuru.Domain.Entities.AdminEmailCampaignRecipient", b =>
                {
                    b.HasOne("MyDhathuru.Domain.Entities.AdminEmailCampaign", "AdminEmailCampaign")
                        .WithMany("Recipients")
                        .HasForeignKey("AdminEmailCampaignId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AdminEmailCampaign");
                });
            ...
            modelBuilder.Entity("MyDhathuru.Domain.Entities.BptAdjustment", b =>
                {
                    b.HasOne("MyDhathuru.Domain.Entities.BptCategory", "BptCategory")
                        .WithMany("Adjustments")
                        .HasForeignKey("BptCategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("BptCategory");
                });
            ...
            modelBuilder.Entity("MyDhathuru.Domain.Entities.DeliveryNote", b =>
                {
                    ...
                    b.HasOne("MyDhathuru.Domain.Entities.Quotation", "Quotation")
                        .WithOne("ConvertedDeliveryNote")
                        .HasForeignKey("MyDhathuru.Domain.Entities.DeliveryNote", "QuotationId")
            ...
            modelBuilder.Entity("MyDhathuru.Domain.Entities.SalesAdjustment", b =>
                {
                    ...
                    b.HasOne("MyDhathuru.Domain.Entities.Invoice", "RelatedInvoice")
                        .WithMany()
            ...
            modelBuilder.Entity("MyDhathuru.Domain.Entities.StaffConductExportDocument", b =>
                {
                    b.HasOne("MyDhathuru.Domain.Entities.StaffConductForm", "StaffConductForm")
                        .WithMany("ExportDocuments")
                        .HasForeignKey("StaffConductFormId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("StaffConductForm");
                });
            ...
            modelBuilder.Entity("MyDhathuru.Domain.Entities.Quotation", b =>
                {
                    b.Navigation("ConvertedDeliveryNote");
